...
/*Updates and displays details of personality 'Ewama Joseph' in the Database*/
/*Updates details of personality 'Ewama Joseph' to 'Ayaka Robinah' */
...
if((this.firstname=="Ewama") && (this.lastname=="Joseph")) {

this.firstname="Ayaka";
this.lastname="Robinah";
this.age="24";
